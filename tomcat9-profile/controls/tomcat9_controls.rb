...
# 26. Restrict access to jaspic-providers.xml
control 'tomcat9-26' do
  impact 0.5
  title 'Restrict access to jaspic-providers.xml'
  desc 'Ensure jaspic-providers.xml is owned by tomcat user and group.'
  describe file(TOMCAT_CONF_JASPIC) do
    it { should be_owned_by 'tomcat' }
    it { should be_grouped_into 'tomcat' }
    its('mode') { should cmp '0640' }
  end
...
# 27. Use secure Realms
control 'tomcat9-27' do
  impact 0.5
...
# 28. Use LockOut Realms
control 'tomcat9-28' do
  impact 0.5
...
# 29. Setup Client-cert Authentication
control 'tomcat9-29' do
  impact 0.5
...
# 30. Ensure SSLEnabled is set to True for Sensitive Connectors
control 'tomcat9-30' do
  impact 0.5
...
# 31. Ensure scheme is set accurately
control 'tomcat9-31' do
  impact 0.5
...
# 32. Ensure secure is set to true only for SSL-enabled Connectors
control 'tomcat9-32' do
  impact 0.5
...
# 33. Ensure SSL Protocol is set to TLS for Secure Connectors
control 'tomcat9-33' do
  impact 0.5
...
# 62. Ensure Manager Application Passwords are Encrypted
control 'tomcat9-62' do
  impact 0.5
